...
if __name__ == "__main__":
    ...
    parser.add_argument("--optim-method", default='SGD', type=str, help="['SGD','Adam', 'AdamW', 'LieGRoupSGD_HB', 'LieGRoupSGD_NAG_SC']")
    parser.add_argument("--constraint", default=None, type=str, help="['Across', None]")
    ...
    parser.add_argument("--NAG_SC", default=0, type=int)
    ...
    assert optim_method in ['SGD','Adam', 'AdamW', 'LieGRoupSGD_HB', 'LieGRoupSGD_NAG_SC']
    assert args.constraint in ['Across', None]
    if args.lr==None:
        if optim_method in ['SGD']:
            args.lr=1e-1 # already carefully adjusted
        elif optim_method in ['LieGRoup_HB', 'LieGRoup_NAG_SC']:
    ...
    if args.experiment_name== None:
        attribute_list=[str(attribute) for attribute in [args.dataset, args.lr, args.optim_method, args.constraint]]
